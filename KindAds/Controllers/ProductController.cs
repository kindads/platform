    ...
    public class ProductController : BaseController {
        ...
        private string GetImageAzure(Models.Core.FileUpload fileUpload)
        {
            if (fileUpload.FileData != null && fileUpload.Filextension != null) {
                return Helpers.AzureStorageHelper.CreateBlobImageFile(fileUpload.FileData, fileUpload.Filextension,480,480);
            }
            else { return ""; }
        }
        ...
        public JsonResult PartnerSelecc(string id)
        {
            ...
            if (Utils.Constants.PROVIDER_AWEBER.Equals(id)) {
                return Json(new { success = true, isProviderAWeber = true, linkAWeber = Utils.Configuration.AppSettings.provideraweberauthorizeappurl, isProviderActiveCampaign = false, isProviderIContact = false });
            }
        ...
        public bool IsValidproviderapikeysendgrid(string key)
        {
