...
* 
 * Code Sourced From: http://oauth.googlecode.com/svn/code/csharp/OAuthBase.cs 
 * Unable to find Author to credit
*/
...
namespace KindAds.Common.Utils.Partners.Mail.Aweber.OAuth
{
    public class Base
    {
        ...
        /// <param name="httpMethod">The http method used. Must be a valid HTTP method verb (POST,GET,PUT, etc)</param>
        /// <returns>A base64 string of the hash value</returns>
        public string GenerateSignature(Uri url, string consumerKey, string consumerSecret, string token, string tokenSecret, string httpMethod, string timeStamp, string nonce, SortedList<String, String> parameters, out string normalizedUrl, out string normalizedRequestParameters)
        {
            return GenerateSignature(url, consumerKey, consumerSecret, token, tokenSecret, httpMethod, timeStamp, nonce, SignatureTypes.HMACSHA1, parameters, out normalizedUrl, out normalizedRequestParameters);
        }
