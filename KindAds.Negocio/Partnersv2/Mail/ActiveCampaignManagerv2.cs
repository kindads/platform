...
{
    public class ActiveCampaignManagerv2 : BaseManager, IMailChannel
    {
        #region properties
        public IList<AudiencePropertieSetting> settings { set; get; }
        public bool AreSettingsValid { set; get; }

        public ActiveCampaignManager manager { set; get; }
        ...
        {
            bool result = false;
            manager = new ActiveCampaignManager();

            // url is required before call this method
        ...
        public ActiveCampaignManagerv2(IList<AudiencePropertieSetting> settings, string emailProductId)
        {
            this.settings = settings;
            this.manager = new ActiveCampaignManager(settings);
        ...
        public ActiveCampaignManagerv2(string emailProductId)
        {
            LoadSettings(emailProductId);
            this.manager = new ActiveCampaignManager(settings);
            this.Url = string.Empty;
        ...
        public ActiveCampaignManagerv2() { this.Url = string.Empty; }
