...
{
    public class MailJetManagerv2 : BaseManager, IMailChannel
    {
        #region properties
        public IList<AudiencePropertieSetting> settings { set; get; }

        public MailJetManager manager { set; get; }
        ...
        #region constructors
        public MailJetManagerv2(IList<AudiencePropertieSetting> settings, string emailProductId)
        {
            this.settings = settings;
            this.manager = new MailJetManager(settings);
        ...
        public MailJetManagerv2(string emailProductId)
        {
            LoadSettings(emailProductId);
            this.manager = new MailJetManager(settings);
