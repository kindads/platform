...
{
    public class CampaignMonitorManagerv2 : BaseManager, IMailChannel
    {
        #region properties
        public IList<AudiencePropertieSetting> settings { set; get; }
        public bool AreSettingsValid { set; get; }
        public CampaignMonitorManager manager { set; get; }
        #endregion
        ...
        {
            bool result = false;
            manager = new CampaignMonitorManager();
        ...
        #region constructors
        public CampaignMonitorManagerv2(IList<AudiencePropertieSetting> settings, string emailProductId)
        {
            this.settings = settings;
            this.manager = new CampaignMonitorManager(settings);
        ...
        public CampaignMonitorManagerv2(string emailProductId)
        {
            LoadSettings(emailProductId);
            this.manager = new CampaignMonitorManager(settings);
        ...
        public CampaignMonitorManagerv2() { }
