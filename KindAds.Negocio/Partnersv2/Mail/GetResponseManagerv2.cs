...
{
    public class GetResponseManagerv2 : BaseManager , IMailChannel
    {
        #region properties
        public IList<AudiencePropertieSetting> settings { set; get; }
        public bool AreSettingsValid { set; get; }
        public GetResponseManager manager { set; get; }
        ...
        {
            bool result = false;
            manager = new GetResponseManager();
        ...
        public GetResponseManagerv2(IList<AudiencePropertieSetting> settings, string emailProductId)
        {
            this.settings = settings;
            this.manager = new GetResponseManager(settings);
        ...
        public GetResponseManagerv2(string emailProductId)
        {
            LoadSettings(emailProductId);
            this.manager = new GetResponseManager(settings);
