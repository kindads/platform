...
{
    public class MailChimpManagerv2 : BaseManager, IMailChannel
    {
        #region properties
        public IList<AudiencePropertieSetting> settings { set; get; }
        public bool AreSettingsValid { set; get; }

        public MailChimpManager manager { set; get; }
        ...
        public MailChimpManagerv2(IList<AudiencePropertieSetting> settings, string emailProductId)
        {
            this.settings = settings;
            this.manager = new MailChimpManager(settings);
        ...
        public MailChimpManagerv2(string emailProductId)
        {
            LoadSettings(emailProductId);
            this.manager = new MailChimpManager(settings);
