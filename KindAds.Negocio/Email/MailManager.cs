...
using KindAds.Common.Structures;
using KindAds.Business.Utilerias;
using SendGrid;
...
namespace KindAds.Business.Email
{
    public class MailManager 
    {
        ...
        {
            string apiKey = ConfigurationManager.AppSettings["provider-apikey-sendgrid"];
